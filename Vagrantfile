...
Vagrant.configure("2") do |config|
    config.vm.define "test1" do |test1|
        ...
        test1.vm.synced_folder "./", "/vagrant", type: "rsync",rsync__exclude: ["tracer/target","checkouts","build","repos","tests/bugdetection/redisraft/*","lazyfs/tmp","rw/Anduril/","tracer/libbpf-rs"]
    ...
    config.vm.define "test2" do |test2|
        ...
        test2.vm.synced_folder "./", "/vagrant", type: "rsync",rsync__exclude: ["tracer/target","build","repos","tracer/libbpf-rs"]
    ...
    config.vm.define "test3" do |test3|
        ...
        test3.vm.synced_folder "./", "/vagrant", type: "rsync",rsync__exclude: ["tracer/target","build","repos","tracer/libbpf-rs"]

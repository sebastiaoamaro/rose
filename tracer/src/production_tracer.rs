...
pub fn run_tracing(
    ...
    let skel_builder = production_tracer::ProductionTracerSkelBuilder::default();
    ...
    let mut skel: production_tracer::ProductionTracerSkel<'static> = open_skel.load()?;
    ...
    let mut skel_enum: SkelEnum<'_, 'static> = SkelEnum::Production(&mut skel);
    start_tracing(
        mode,
        functions,
        binary_path,

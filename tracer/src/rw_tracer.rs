...
pub fn run_tracing(
    ...
    let skel_builder = rw_tracer::RwTracerSkelBuilder::default();
    ...
    let mut skel: rw_tracer::RwTracerSkel<'static> = open_skel.load()?;
    ...
    let mut skel_enum: SkelEnum<'_, 'static> = SkelEnum::RwTracer(&mut skel);
    start_tracing(
        mode,
        functions,
        binary_path,

...
execution_plan* build_execution_plan(){
    ...
    create_execution_plan(exe_plan,"/home/sebastiaoamaro/phd/torefidevel/schedules/reproducedbugs/startredpanda.sh",5,"");
    return exe_plan;
}
node* build_nodes(){
    node* nodes = ( node*)malloc(NODE_COUNT * sizeof(node));
    create_node(&nodes[0],"redpanda1",0,"","","","",1);
...
fault* build_faults_extra(){
    ...
    create_fault(&faults[0],"process_pause",0,14,1,fault_details0,0,0,5,1);

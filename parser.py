import yaml
import sys
from schedule_parser.faults import parse_faults, build_faults_cfile
from schedule_parser.nodes import parse_nodes, build_nodes_cfile
from schedule_parser.aux import calculate_fault_count
from schedule_parser.execution_plan import parse_execution_plan,build_plan_cfile,build_empty_plan_cfile
from schedule_parser.tracer import parse_tracer,build_tracer_cfile,build_empty_tracer_cfile
...
def build_cfile(nodes,faults,plan,tracer,max_time):
    ...
    file = open('fault_schedule.c','w+')

    file_template = open('schedule_parser/fault_schedule_template.c').read()

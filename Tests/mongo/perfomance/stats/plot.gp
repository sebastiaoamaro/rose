...
plot for [i=2:9] "cpu_usage.data" using 0:i with linespoint
...
set title 'CPU usr + sys dstat'
#use the first and second columns from data file data.data
plot for [i=10:17] "cpu_usage.data" using 0:i with linespoint
...
set title 'CPU usr + sys dstat'
#use the first and second columns from data file data.data
plot for [i=2:17] "cpu_usage.data" using 0:i with linespoint
...
cd /vagrant/schedules/reproduced_bugs/redisraft/lxc/redisraft_jepsen
setsid lein run test-all --nemesis none --time-limit 60 --test-count 1 --username root --concurrency 4n --nodes-file /home/vagrant/nodes  --ssh-private-key /home/vagrant/.ssh/id_rsa > /tmp/jepsen.log 2>&1 &
pid=$!
